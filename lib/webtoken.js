 ...
 * After calling `authenticate`, any request to an endpoint using the `Model` or
 * `Collection` classes or the `jsonapi` function, will be authenticated.
 */
class WebToken {
   ...
   * @param {string} uri - The `uri` to refresh against.
   */
  async refresh(uri) {
    if(!uri) {
